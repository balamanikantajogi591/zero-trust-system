      ...
      >
        ...
        {step === 'mfa' ? (
          ...
          <>
            ...
            <div className="my-6">
              {import.meta.env.VITE_GOOGLE_CLIENT_ID && import.meta.env.VITE_GOOGLE_CLIENT_ID !== "missing-client-id" ? (
                <GoogleLogin
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    const mockUserData = {
                      role: 'ADMIN',
                      email: 'balamanikantajogi591@gmail.com',
                      name: 'Bala Manikanta',
                      picture: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Bala',
                  ...
                  className="w-full flex items-center justify-center gap-3 bg-[#131314] hover:bg-[#1f1f1f] text-white py-2.5 rounded-full border border-[#444] transition-all font-medium text-sm shadow-[0_1px_2px_0_rgba(60,64,67,0.3)]"
                >

  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-400">Manage your Zero Trust profile and security preferences.</p>
      </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex">
                  ...
                  <input type="text" disabled value="admin@zerotrust.local" className="flex-1 bg-black/40 border-y border-r border-white/10 rounded-r px-4 py-2 text-gray-300 focus:outline-none" />
                </div>
              </div>
